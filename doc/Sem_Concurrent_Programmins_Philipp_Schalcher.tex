...
Im ersten Abschnitt des Quellcodes (nur eine Zeile) wird die Eingabe von CTRL+C abgefangen, damit Semaphore, Shared Memory und der Netzwerkteil sauber geschlossen werden. Danach folgt der Aufbau des Shared-Memory. Über eine Referenzdatei wird der Shared Memory Key generiert, welcher shmget benutzt, um das Memory aufzubauen. Das Struktur-Array wird schlussendlich mit dem Shared Memory verknüpft.
\section{Netzwerk}
\subsection{Testing}
